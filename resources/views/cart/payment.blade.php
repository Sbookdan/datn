                                        ...
                                        <div class="col-sm-10">
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="shipping"
                                                    id="shipradio_1" value="1" checked>
                                            </div>
                                        </div>
                                        <div class="card-body">
                                ...
                                <div class="col-sm-6">
                                    <div class="card">
                                        <div class="col-sm-10">
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="shipping"
                                                    id="shipradio_2" value="2" checked>
                                            </div>
                                        </div>
                                        <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="inf-product">
                                @foreach ($totalproduct as $totalpro)
                                <p>Tạm tính( {{$totalpro->number}} Sảm Phẩm)</p>
                                @endforeach
                            </div>
                        </div>
                        <div class="col-md-6">
                            ...
                            <div class="form-row">
                                <input type="text" class="form-control"
                                    value="{{ number_format(($totalpro->number * $totalpro->price) + 10 - ($totalpro->number * 3))}}.000 VND"
                                    readonly>
                            </div>
                            @endforeach
                        </div>
                            ...
                            <div class="col-8">
                                <div class="tab-content" id="nav-tabContent">
                                    ...
                                    <div class="tab-pane fade show {{ $paycart->id == 1 ? 'active' : '' }}"
                                        id="list-home{{ $paycart->id }}" role="tabpanel"
                                        ...
                                        @foreach ($totalproduct as $totalpro)
                                        <input type="hidden" value="{{ number_format(($totalpro->number * $totalpro->price) + 10 - ($totalpro->number * 3)) }}" 
                                        id="price" name="total_all">
                                        <input type="hidden" name="id_cart" value="{{$totalpro->id}}">
                                        @endforeach
